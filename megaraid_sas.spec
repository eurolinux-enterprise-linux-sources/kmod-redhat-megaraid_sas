...
%define kmod_driver_version	07.702.06.00_rh2_dup7.5
...
%{!?dist: %define dist .el7_5}
%{!?make_build: %define make_build make}

Source0:	%{kmod_name}-%{kmod_vendor}-%{kmod_driver_version}.tar.bz2
# Source code patches
Patch0:	0000-version-bump.patch
Patch1:	0001-scsi-megaraid_sas-use-adapter_type-for-all-gen-contr.patch
Patch2:	0002-scsi-megaraid_sas-Add-support-for-Crusader-controlle.patch
...
Requires:	kernel < 3.10.0-863.el7
%if 0
...
%package -n kmod-redhat-megaraid_sas-firmware
Version:	ENTER_FIRMWARE_VERSION
Summary:	megaraid_sas firmware for Driver Update Program
Provides:	firmware(%{kmod_name}) = ENTER_FIRMWARE_VERSION
Provides:	kernel-modules = %{kmod_kernel_version}.%{_target_cpu}
%description -n  kmod-redhat-megaraid_sas-firmware
megaraid_sas firmware for Driver Update Program


%files -n kmod-redhat-megaraid_sas-firmware
...
%package -n kmod-redhat-megaraid_sas-devel
Version:	%{kmod_driver_version}
Requires:	kernel >= 3.10.0-862.el7
Requires:	kernel < 3.10.0-863.el7
Summary:	megaraid_sas development files for Driver Update Program

%description -n  kmod-redhat-megaraid_sas-devel
megaraid_sas development files for Driver Update Program


%files -n kmod-redhat-megaraid_sas-devel
%defattr(644,root,root,755)
...
rpm -ql kmod-redhat-megaraid_sas-%{kmod_driver_version}-%{kmod_rpm_release}%{?dist}.$(arch) | \
...
%changelog
* Tue May 15 2018 Eugene Syromiatnikov <esyr@redhat.com> 07.702.06.00_rh2_dup7.5-1
